"""
Модуль для управления доступа к эндпоинтам на основе ролей.
Можно использовать класс PermissionChecker как зависимость
напрямую или создавать на его основе аннотированные роли.
"""
